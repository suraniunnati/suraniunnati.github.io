...
function About() {
  return (
    ...
    <div className='h-[800px] xl:h-[700px] xl:flex items-center justify-around relative ms-10 xl:ms-0'>
      ...
      <div className='wow animate__animated animate__bounceInRight photo h-[35%] xl:h-[70%] w-[80%]  sm:w-[50%] xl:w-[35%] relative rounded-lg overflow-hidden' >
