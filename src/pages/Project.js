    ...
    <div>
      ...
      <div className='w-[80%] m-auto '>
        <div className='flex h-[300px] '>
          <div className='w-[60%] p-5 border-e-2 border-[#1DBAB5]'><img src={web1} alt="" className='w-full h-full rounded-lg shadow-md shadow-[gray]' /></div>
        ...
        <div className='flex h-[300px]   mt-10'>
          ...
          <div className='w-[60%] p-5 border-s-2 border-[#1DBAB5]'><img src={web2} alt="" className='w-full h-full rounded-lg shadow-md shadow-[gray]' /></div>
        </div>
        <div className='flex h-[300px]  mt-10'>
          <div className='w-[60%] p-5 border-e-2 border-[#1DBAB5]'><img src={web3} alt="" className='w-full h-full rounded-lg shadow-md shadow-[gray]' /></div>
          <div className='w-[40%] p-5 relative'>
          <div className='pr2 h-full w-full absolute top-0 left-0 opacity-10'></div>
