  ...
  return (
    <div className='contact h-[650px] '>
      ...
      <form action="" className='wow animate__animated animate__zoomIn md:w-[50%] m-auto p-5 mt-15'>
        <input type="text" placeholder='Your First Name' className='w-full h-[40px] mt-3 ps-2 border border-[gray] shadow-sm shadow-[gray] bg-transparent rounded-md'/>
        <input type="text" placeholder='Your Last Name' className='w-full h-[40px] mt-3 ps-2 border border-[gray] shadow-sm shadow-[gray] bg-transparent rounded-md'/>
        ...
        <textarea name="" id="" placeholder='Message' className='w-full h-[120px] mt-3 ps-2 border border-[gray] shadow-sm shadow-[gray] bg-transparent rounded-md'></textarea>
